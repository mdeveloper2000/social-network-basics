...
window.onload = async () => {
    ...
    const formData = new FormData()
    formData.append("query", "listFriendsRequests")    
    ...
    try {
        ...
        .then((data) => {            
            if(data === null) {
                ...
                data.invites_accepted.forEach(usuario => {
...
async function aceitarConvite(bannerClass, id) {
    const formData = new FormData()
    formData.append("query", "aceitarConvite")
    ...
    async function cancelarConvite(bannerClass, id) {
        const formData = new FormData()
        formData.append("query", "cancelarConvite")
        formData.append("id", id)
        try {
